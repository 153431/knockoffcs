...
dantzig01_signal1 = np.load('dantzig01_signal-1.npy',  allow_pickle=True)
dantzig01_signal2 = np.load('dantzig01_signal-2.npy',  allow_pickle=True)
dantzig01_signal3 = np.load('dantzig01_signal-3.npy',  allow_pickle=True)
dantzig01_signal4 = np.load('dantzig01_signal-4.npy',  allow_pickle=True)
dantzig01_signal5 = np.load('dantzig01_signal-5.npy',  allow_pickle=True)

dantzig01_signal = np.vstack((dantzig01_signal1, dantzig01_signal2, dantzig01_signal3, dantzig01_signal4, dantzig01_signal5))
print(dantzig01_signal.shape)

#CLIME01_signal = np.load('CLIME01_signal.npy',  allow_pickle=True)
labels = np.load("Original Dataset_labels.npy", allow_pickle=True)

total_size = dantzig01_signal.shape[0]
high_dim = dantzig01_signal.shape[1]
...
with open("output- dantzig - new.txt", "w", encoding="utf-8") as file:
